...
<body class="p-3 mb-2 bg-dark text-white">
    <div class="d-flex flex-column mx-auto" style="width: 600px; margin-top: 60px">
        ...
        <!-- <div class="split right"> -->
            <shadow class="text-center">Philoi is a quiz game designed to test how well friends know each other</shadow>
        <!-- </div>   -->
    ...
    <div class="col text-center">
        ...
        <button class="mx-auto btn btn-secondary mt-3" style="width: 160px" onclick="location.href = 'index.php'">Back</button>
    </div>
    </div>
